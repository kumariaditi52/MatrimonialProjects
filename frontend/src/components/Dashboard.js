  ...
  //     // Navigate to ProfileView when a match is clicked
  //     navigate('/ProfileView', { state: { selectedMatchId: matchId } });
  //   };
  ...
  //           <div onClick={handleProfileViewClick} style={{ cursor: 'pointer' }}>
  //             <StatCard 
...
//               ? `linear-gradient(45deg, ${color}40 30%, ${color}20 90%)`
...
//       }}>
//         <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
//           <Typography variant="h6" color={theme.palette.mode === 'dark' ? 'white' : 'black'}>
//             Activity Overview
//           </Typography>
...
//               <XAxis dataKey="month" stroke={theme.palette.mode === 'dark' ? "#fff" : "#000"} />
//               <YAxis stroke={theme.palette.mode === 'dark' ? "#fff" : "#000"} />
//               <Tooltip 
//                 contentStyle={{ 
...
//   // Continue updating the other components in a similar way
...
//           : '1px solid rgba(0, 0, 0, 0.1)'
//       }}>
//         <Typography variant="h6" color={theme.palette.mode === 'dark' ? 'white' : 'black'} gutterBottom>
//           Recent Matches
//         </Typography>
//         <List>
//           {recentMatches.map((match) => (
...
//                 <Box sx={{ display: 'flex', alignItems: 'center' }}>
//                   <Avatar src={match.avatar1} sx={{ mr: 1 }} />
//                   <Typography color={theme.palette.mode === 'dark' ? 'white' : 'black'} variant="body2">❤</Typography>
//                   <Avatar src={match.avatar2} sx={{ ml: 1 }} />
//                 </Box>
//                 <Box sx={{ ml: 2, flex: 1 }}>
//                   <Typography color={theme.palette.mode === 'dark' ? 'white' : 'black'} variant="subtitle2">{match.name}</Typography>
//                   <Typography color={theme.palette.mode === 'dark' ? 'gray' : '#555'} variant="caption">{match.date}</Typography>
//                 </Box>
//                 <Chip 
//                   label={`${match.compatibility}% Match`}
//                   size="small"
...
// Add the missing data constants
const activityData = [
  { month: 'Jan', matches: 65, calls: 45, success: 38 },
  { month: 'Feb', matches: 59, calls: 38, success: 30 },
  { month: 'Mar', matches: 80, calls: 60, success: 52 },
      ...
      <TableContainer>
        <Table>
          <TableBody>
            {performanceMetrics.map((metric) => (
              <TableRow key={metric.metric} sx={{ '&:last-child td': { border: 0 } }}>
                <TableCell sx={{ color: theme.palette.mode === 'dark' ? 'white' : 'black', border: 'none' }}>
                  {metric.metric}
                </TableCell>
                <TableCell align="right" sx={{ color: theme.palette.mode === 'dark' ? 'white' : 'black', border: 'none' }}>
                  {metric.value}
                </TableCell>
                <TableCell align="right" sx={{ color: '#4caf50', border: 'none' }}>
                  {metric.growth}
...
const Dashboard = () => {
  ...
  return (
    ...
    >
      <Typography variant="h4" sx={{ color: theme.palette.mode === 'dark' ? '#fff' : '#333', mb: 4, fontWeight: 'bold' }}>
        <Button
          onClick={handleProfileViewClick}
          color="inherit"
          sx={{
