...
//         <Typography variant="body1" color={theme.palette.mode === 'dark' ? 'white' : 'black'}>
//           {profile.gender}
//         </Typography>
//       </Grid>
//       <Grid item xs={6}>
...
import { 
  Typography, Button, Paper, Box, Avatar, Divider, List, 
  ListItem, ListItemText, IconButton, LinearProgress, Grid, Chip, useTheme
} from '@mui/material';
import { motion, AnimatePresence } from 'framer-motion';
import PhoneInTalkIcon from '@mui/icons-material/PhoneInTalk';
import CallEndIcon from '@mui/icons-material/CallEnd';
...
const CallManagement = ({ profileData }) => {
  ...
  if (!profileData) {
    return (
      ...
      >
        <PersonIcon sx={{ fontSize: 60, color: theme.palette.mode === 'dark' ? '#555' : '#e0e0e0', mb: 2 }} />
        <Typography variant="h6" color="textSecondary">
          Please select a profile to manage calls
        </Typography>
      </Paper>
    );
  }
